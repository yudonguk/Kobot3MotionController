...
#define CUSTOMHID_SIZ_REPORT_DESC               (7 + 15 * 8 + 1)
#define CUSTOMHID_SIZ_STRING_LANGID             4
#define CUSTOMHID_SIZ_STRING_VENDOR             44
#define CUSTOMHID_SIZ_STRING_PRODUCT            40
#define CUSTOMHID_SIZ_STRING_SERIAL             26

#define STANDARD_ENDPOINT_DESC_SIZE             0x09

#define CUSTOMHID_SIZ_ENDPOINT1_IN_MAX_PACKET (1 + 24)
#define CUSTOMHID_SIZ_ENDPOINT1_OUT_MAX_PACKET (1 + 24)
